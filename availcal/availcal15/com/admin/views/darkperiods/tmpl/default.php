...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th width="120"><?php echo JHTML::_( 'grid.sort', JText::_('Naam'), 'naam', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
			<th width="80"><?php echo JText::_('busy'); ?></th>			
			<th width="80"><?php echo JHTML::_( 'grid.sort', JText::_('Start Datum'), 'start_date', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
			<th width="80"><?php echo JHTML::_( 'grid.sort', JText::_('Eind Datum'), 'end_date', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>			
