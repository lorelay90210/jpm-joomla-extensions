...
<table class="admintable">
	...
	<tr>
		<td width="100" align="right" class="key"><span
			...
			style="text-decoration: none; color: #333;"> <label for="start_date"><?php echo JText::_( 'START DATUM' ); ?>:</label>
		</span></td>
		<td><?php 
	...
	<tr>
		<td width="100" align="right" class="key"><span
			...
			style="text-decoration: none; color: #333;"> <label for="end_date"><?php echo JText::_( 'EIND DATUM' ); ?>:</label></span></td>
		<td><?php 
		echo JHTML::_('calendar',
